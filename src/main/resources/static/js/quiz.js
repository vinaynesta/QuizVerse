...
function showQuestion() {
    ...
    container.innerHTML = `
        <div class="question">
            ...
            <div class="options">
                <div class="option" data-answer="${encodeURIComponent(question.option_a)}">${question.option_a}</div>
                <div class="option" data-answer="${encodeURIComponent(question.option_b)}">${question.option_b}</div>
                <div class="option" data-answer="${encodeURIComponent(question.option_c)}">${question.option_c}</div>
                <div class="option" data-answer="${encodeURIComponent(question.option_d)}">${question.option_d}</div>
            </div>
        </div>
    `;
    ...
    optionElements.forEach(opt => {
        opt.addEventListener('click', () => selectOption(opt, opt.getAttribute('data-answer')));
    });
}
    ...
    try {
        ...
        if (result.correct) {
            ...
            const correctOption = Array.from(options).find(opt =>
                opt.textContent.trim() === result.correctAnswer.trim()
            );
